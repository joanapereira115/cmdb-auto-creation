...
def run_nmap():
    ...
    """
    for ip in discovery_info.discovery_info.get("ip_addresses"):
        if ip not in discovery_info.discovery_info.get("visited_addresses"):
            discovery_info.discovery_info["visited_addresses"].append(ip)
            print(blue + ">>> " + reset +
                ...
                for proto in nm[h].all_protocols():
                    ...
                    for port in ports:
                        ...
                        if nm[h][proto][port]['state'] != '':
                            p.set_status(
                                nm[h].get(proto).get(port).get('state'))
